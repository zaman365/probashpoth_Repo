...
| R8      | Unified implementation guide | QuickCheck, coverage maturity, official handoffs, application QA snapshots, ROI/debt, Trust Center/safety, universal saves/deadlines, journey command centre and P1/P2 typed foundations | Complete repository verification; named data owners; reviewed live sources; legal/external gates for enabled networks | P0 engineering complete; P1/P2 foundations complete; operating gates open |
...
- R8: shared unified domain/contracts, additive PostgreSQL migration and encrypted
  storage namespaces; anonymous QuickCheck; honest route coverage and Bangladesh
  accessibility; official action catalogue with user-confirmed provenance; immutable
  QA snapshots; conservative ROI/debt; universal deadlines/saves; structured safety
  checks; Trust Center/freshness dashboard; grounded Copilot shell; shared-device
  session revocation; Bangla/English public web and Android entry surfaces.
